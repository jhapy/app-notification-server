...
public class SmsTemplateEndpoint extends BaseEndpoint {
  ...
  public ResponseEntity<ServiceResult> getById(@RequestBody GetByStrIdQuery query) {
    ...
    return handleResult(loggerPrefix,
        getConverter().convertToDto(smsTemplateService.load(query.getId())));
  }
  ...
  public ResponseEntity<ServiceResult> getBySmsAction(@RequestBody GetByNameQuery query) {
    ...
    return handleResult(loggerPrefix, getConverter().convertToDto(smsTemplateService
        .getBySmsAction(query.getName())));
  }
  ...
  public ResponseEntity<ServiceResult> save(
    ...
    return handleResult(loggerPrefix, getConverter()
        .convertToDto(smsTemplateService.save(getConverter().convertToDomain(query.getEntity()))));
  }
