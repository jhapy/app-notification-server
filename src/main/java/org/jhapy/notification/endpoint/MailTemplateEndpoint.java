...
public class MailTemplateEndpoint extends BaseEndpoint {
  ...
  public MailTemplateEndpoint(
      MailTemplateService mailTemplateService, NotificationConverterV2 converter) {
    super(converter);
  ...
  public ResponseEntity<ServiceResult> findAnyMatching(@RequestBody FindAnyMatchingQuery query) {
    ...
    Page<MailTemplate> result =
        mailTemplateService.findAnyMatching(
  ...
  public ResponseEntity<ServiceResult> countAnyMatching(@RequestBody CountAnyMatchingQuery query) {
    ...
    return handleResult(loggerPrefix, mailTemplateService.countAnyMatching(query.getFilter()));
  }
  ...
  public ResponseEntity<ServiceResult> getById(@RequestBody GetByIdQuery query) {
    ...
    return handleResult(
        loggerPrefix, getConverter().convertToDto(mailTemplateService.load(query.getId())));
  }
  ...
  public ResponseEntity<ServiceResult> getByMailAction(@RequestBody GetByNameQuery query) {
    ...
    return handleResult(
        loggerPrefix,
        getConverter().convertToDto(mailTemplateService.getByMailAction(query.getName())));
  }
  ...
  public ResponseEntity<ServiceResult> save(
    ...
    return handleResult(
        ...
        getConverter()
            .convertToDto(
                mailTemplateService.save(getConverter().convertToDomain(query.getEntity()))));
  }
