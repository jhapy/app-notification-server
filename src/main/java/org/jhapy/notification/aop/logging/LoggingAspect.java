...
package org.jhapy.notification.aop.logging;
...
public class LoggingAspect implements HasLogger {
   ...
   */
  @Pointcut("target(org.jhapy.notification.service.BaseCrudService)")
  public void serviceEndpoint() {
    // Method is empty as this is just a Pointcut, the implementations are in the advices.
  }

  @Pointcut("!execution(@org.jhapy.notification.aop.logging.NoLog * *(..))")
